# "Vegetation-based climate mitigation in a warmer and greener World"  Nature Comunications 2021
...
To do this we use "Job.py" python program that import a function "nearby" with is based on a fortran program "nearby.f90" that is compiled using f2py in order to estimate dT/dLAI.
